...
/*
 * Name: Sensor Test for VCU functionality
 * Brian Glen
 * 11/13/24
 *
 * Description
 * - Sensor test for bring-up and hardware validation
 * - F & R brake pressure sensors (ADC)
 * - APPS sensors (ADC)
 * - Steering angle sensor (I2C)
 * - functions for basic plausibility checking
 * - Sends data via USB and a virtual com port
 *
 * TODO:
 * - update ADC clock for slower sampling rate
 * - read steering sensor datasheet / write driver
 * - Need to eliminate some of this autogenerated crap eventually
 */
